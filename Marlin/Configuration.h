...
#define X_MIN_POS -10  // GKH: X position when at home
#define Y_MIN_POS -45  // GKH: Y position when at home
#define Z_MIN_POS 0
...
//
// Display original -> need to enable ULTRA_LCD above
...
//
// Display grafico -> need to dissable ULTRA_LCD above
